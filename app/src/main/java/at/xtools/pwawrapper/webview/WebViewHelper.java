...
public class WebViewHelper {
    ...
    public WebViewHelper(MainActivity activity, UIManager uiManager) {
    ...
    private boolean handleUrlLoad(WebView view, String url) {
        ...
        if (!url.startsWith(Constants.WEBAPP_URL)) {
            ...
            if(url.contains("talkabit.org/pages/speakers")) activity.setCurrentPage_ID(2);
            else if(url.contains("talkabit.org/pages/program")) activity.setCurrentPage_ID(3);
            else if(url.contains("talkabit.org/pages/profile")) activity.setCurrentPage_ID(4);
            else if(url.contains("talkabit.org")) activity.setCurrentPage_ID(1);
